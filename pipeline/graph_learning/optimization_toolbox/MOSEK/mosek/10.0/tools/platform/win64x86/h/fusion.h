...
namespace mosek
{
  namespace fusion
  {
    ...
    public:
      ...
      BaseVariable(monty::rc_ptr< ::mosek::fusion::Model > m,std::shared_ptr< monty::ndarray< int32_t,1 > > shape,std::shared_ptr< monty::ndarray< int64_t,1 > > sparsity,std::shared_ptr< monty::ndarray< int64_t,1 > > nativeidxs);
      virtual /* override */ std::string toString() ;
      ...
      virtual int32_t inst(int32_t spoffset,std::shared_ptr< monty::ndarray< int64_t,1 > > sparsity,int32_t nioffset,std::shared_ptr< monty::ndarray< int64_t,1 > > nativeidxs) ;
    ...
    public:
      ...
      virtual int32_t inst(int32_t offset,std::shared_ptr< monty::ndarray< int64_t,1 > > sparsity,std::shared_ptr< monty::ndarray< int64_t,1 > > nativeidxs) ;
    ...
    public:
      ...
      Constraint(monty::rc_ptr< ::mosek::fusion::Model > model,std::shared_ptr< monty::ndarray< int32_t,1 > > shape,std::shared_ptr< monty::ndarray< int32_t,1 > > nativeidxs);
      virtual /* override */ std::string toString() ;
      virtual std::shared_ptr< monty::ndarray< double,1 > > dual() ;
      virtual std::shared_ptr< monty::ndarray< double,1 > > level() ;
      virtual void remove() ;
    ...
    public:
      ...
      ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > expr,std::shared_ptr< monty::ndarray< int64_t,1 > > vsub,std::shared_ptr< monty::ndarray< double,1 > > vcof);
      ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > expr,std::shared_ptr< monty::ndarray< double,1 > > vcof);
      ExprInner(monty::rc_ptr< ::mosek::fusion::Expression > expr,std::shared_ptr< monty::ndarray< int32_t,2 > > vsub,std::shared_ptr< monty::ndarray< double,1 > > vcof);
      virtual /* override */ void eval(monty::rc_ptr< ::mosek::fusion::WorkStack > rs,monty::rc_ptr< ::mosek::fusion::WorkStack > ws,monty::rc_ptr< ::mosek::fusion::WorkStack > xs) ;
      virtual /* override */ std::string toString() ;
    }; // class ExprInner;
